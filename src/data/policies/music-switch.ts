...
export const musicSwitchPolicy: ProductPolicy = {
  privacy: {
    en: `## Privacy Policy — Music Switch
...
- GitHub: [github.com/zhanggenlove](https://github.com/zhanggenlove)`,
  ...
  terms: {
    en: `## Terms of Service — Music Switch
