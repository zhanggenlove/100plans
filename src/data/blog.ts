...
export const blogPosts: BlogPost[] = [
  {
    ...
    tags: ['announcement'],
    title: {
      en: 'Hello World — 100Plans is Here',
      zh: 'Hello World — 100Plans 来了',
      ja: 'Hello World — 100Plans が始動します',
    },
    excerpt: {
      en: 'A short introduction to the studio, the mission behind the work, and the eight apps that make up our lineup today.',
      zh: '介绍工作室、创作使命，以及目前 lineup 中的八款应用。',
      ja: 'スタジオの紹介、ミッション、そして現在の8本のアプリについて。',
    },
    content: {
      en: `# Hello World — 100Plans is Here
...
Thank you for stopping by. The best is yet to come.`,
...
訪れてくれてありがとうございます。これからが本番です。`,
    },
  },
  {
    slug: 'building-zzzappy',
    date: '2026-03-15',
    tags: ['development', 'zzzappy'],
    title: {
      en: 'Building Zzzappy: Protecting Developer Health',
      zh: '打造 Zzzappy：守护开发者的健康',
      ja: 'Zzzappy を作る：開発者の健康を守る',
    },
    excerpt: {
      en: 'Why we built reminders around the 20-20-20 rule, how we approached RSI prevention, and the trade-offs behind a calm, native Mac experience.',
      zh: '围绕 20-20-20 法则做提醒、RSI 预防的思路，以及在原生 Mac 体验上的取舍。',
      ja: '20-20-20ルール、RSI予防、落ち着いたネイティブMac体験のトレードオフについて。',
    },
    content: {
      en: `# Building Zzzappy: Protecting Developer Health
...
Zzzappy is a living project. If you rely on your hands and eyes to build things, we built it for you.`,
...
Zzzappy 会持续迭代。如果你也靠双手和眼睛创造东西，它就是为你而写的。`,
...
Zzzappy は育つプロジェクトです。手と目でものを作る人のために、作っています。`,
    },
  },
  {
    slug: 'coin-focus-story',
    date: '2026-03-10',
    tags: ['development', 'coin-focus'],
    title: {
      en: 'Why I Built Coin Focus from Scratch',
      zh: '为什么我从零开始做了 Coin Focus',
      ja: 'Coin Focus を一から作った理由',
    },
    excerpt: {
      en: 'A finance app born from distrust of bloated dashboards and cloud-first ledgers—and why SwiftUI was the right bet for a privacy-first wallet.',
      zh: '源于对臃肿面板与「先上云」记账的不信任；以及为何用 SwiftUI 做隐私优先的钱包。',
      ja: '肥大化したダッシュボードとクラウド優先の家計簿への違和感から。プライバシー第一の財布にSwiftUIが合った理由。',
    },
    content: {
      en: `# Why I Built Coin Focus from Scratch
...
If that sounds like your bar, we built it with you in mind.`,
