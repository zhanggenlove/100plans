    ...
    <div class="relative z-10 mx-auto max-w-5xl px-6 pt-24 pb-16 text-center">
      ...
      <div
        ...
        :style="{
          ...
          transition: 'all 0.75s cubic-bezier(0.16, 1, 0.3, 1) 0.48s',
        }"
      >
        <ProductHuntBadge theme="light" slug="music-switch" post-id="1107592" />
      </div>
      ...
      <div
        ...
        :style="{
          ...
          transition: 'all 0.75s cubic-bezier(0.16, 1, 0.3, 1) 0.56s',
        }"
      >
        <span
